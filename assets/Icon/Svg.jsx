export const PalseIcons = (className) => (
  <svg
    width="33"
    height="32"
    className={className}
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#F85A5A"></stop>
        <stop offset="0.828125" stopColor="#7A5AF8"></stop>
      </linearGradient>
    </defs>
  </svg>
)

export const HeroSvg1 = (className) => (
  <svg
  ...
  >
    ...
    <defs>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stop-color="#f7bc05"></stop>
        <stop offset="1" stop-color="#f7bc05" stop-opacity="0"></stop>
      </linearGradient>
    </defs>
  </svg>
)

export const HeroSvg2 = (className) => (
  <svg
    viewBox="0 0 1026 1026"
    fill="none"
    aria-hidden="true"
